...
export default function BoardColumn({ column, tasks, projectId, onTaskCreated, onOpenTask, dragDisabled }) {
  const { setNodeRef } = useDroppable({ id: column.id, disabled: dragDisabled });

  return (
    <div className="bg-gray-100 rounded-lg p-3 flex-1 min-w-[260px] w-[260px] sm:w-auto flex flex-col snap-start shrink-0">
